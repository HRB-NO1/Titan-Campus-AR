...
* [DialogueFetcher](https://github.com/HRB-NO1/Titan-Campus-AR/blob/main/titan-ar-tour/Assets/AR%20Tuffy%20Related/SampleScript.cs](https://github.com/HRB-NO1/Titan-Campus-AR/blob/main/titan-ar-tour/Assets/AR%20Tuffy%20Related/AR_Fukuoka/Scripts/Dialogue/DialogueFetcher.cs)) - The DialogueFetcher class is a utility designed for fetching dialogue data asynchronously from a remote server and returning it as a TextAsset in Unity. This class leverages Unity's UnityWebRequest to perform HTTP GET requests and handle the responses efficiently.

* [DialogueManager](https://github.com/HRB-NO1/Titan-Campus-AR/blob/main/titan-ar-tour/Assets/AR%20Tuffy%20Related/SampleScript.cs](https://github.com/HRB-NO1/Titan-Campus-AR/blob/main/titan-ar-tour/Assets/AR%20Tuffy%20Related/AR_Fukuoka/Scripts/Dialogue/DialogueFetcher.cs](https://github.com/HRB-NO1/Titan-Campus-AR/blob/main/titan-ar-tour/Assets/AR%20Tuffy%20Related/AR_Fukuoka/Scripts/Dialogue/DialogueManager.cs))) - Designed to manage and control the flow of dialogue within a game. It integrates with the Ink storytelling system and handles user interactions through touch input. The class is responsible for initializing and displaying dialogues, handling user choices, and managing the transition between dialogue states.
